<div class='layout_width'>
	...
	<div class='content_box'>
		<form method='post' action='indb' target='ifrmHidden' autocomplete='off' class='board_form' class='board_form'>
			<input type='hidden' name='mode' value='<?=isset($id)?"update":"register"?>_board'>
			<table class='table_cols'>
				<tr>
					<th>게시판 번호</th>
					<td>
						<?php if(isset($boardNo)) : ?>
			...
			<div class='board_submit' align='center'>
