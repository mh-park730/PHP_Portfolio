...
<div class='layout_width'>
	<div class='title1'>회원 <?=isset($memNo)?"정보 수정":"등록"?></div>
	<div class='content_box'>
		<form method='post' action='<?=siteUrl("admin/member/indb")?>' target='ifrmHidden' autocomplete='off'>
			...
			<div align='center'>
				<input type='submit' value='<?=isset($memNo)?" 수정":" 등록"?> 하기' onclick="return confirm('정말 <?=isset($memNo)?"수정":"등록"?>&nbsp하시겠습니까?');" class='btn1 mt20 mem_update'>
			</div>
		</form>
	</div>
	<!--// content_box -->
